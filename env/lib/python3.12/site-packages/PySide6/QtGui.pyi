...
from typing import Any, Any, Callable, ClassVar, Dict, Dict, Iterable, List, List, Optional, Sequence, Sequence, Set, Set, Tuple, Tuple, Union, Union, overload
...
class QAbstractTextDocumentLayout(PySide6.QtCore.QObject):
    ...
    update                   : ClassVar[Signal] = ... # update(); update(QRectF)
...
class QFont(Shiboken.Object):
    ...
    def family(self) -> str: ...
    def featureTags(self) -> List[PySide6.QtGui.QFont.Tag]: ...
    def featureValue(self, tag: PySide6.QtGui.QFont.Tag) -> int: ...
    ...
    def isFeatureSet(self, tag: PySide6.QtGui.QFont.Tag) -> bool: ...
    def isVariableAxisSet(self, tag: PySide6.QtGui.QFont.Tag) -> bool: ...
    ...
    def setFeature(self, tag: PySide6.QtGui.QFont.Tag, value: int) -> None: ...
    ...
    def setVariableAxis(self, tag: PySide6.QtGui.QFont.Tag, value: float) -> None: ...
    ...
    def unsetFeature(self, tag: PySide6.QtGui.QFont.Tag) -> None: ...
    def unsetVariableAxis(self, tag: PySide6.QtGui.QFont.Tag) -> None: ...
    def variableAxisTags(self) -> List[PySide6.QtGui.QFont.Tag]: ...
    def variableAxisValue(self, tag: PySide6.QtGui.QFont.Tag) -> float: ...
...
class QFontDatabase(Shiboken.Object):
    ...
    @staticmethod
    def addApplicationFontFromData(fontData: Union[PySide6.QtCore.QByteArray, bytes, bytearray, memoryview]) -> int: ...
    @staticmethod
...
class QFontMetrics(Shiboken.Object):
    ...
    @overload
    def boundingRect(self, r: PySide6.QtCore.QRect, flags: int, text: str, tabstops: int = ..., tabarray: Optional[object] = ...) -> PySide6.QtCore.QRect: ...
    @overload
    ...
    @overload
    def boundingRect(self, x: int, y: int, w: int, h: int, flags: int, text: str, tabstops: int = ..., tabarray: Optional[object] = ...) -> PySide6.QtCore.QRect: ...
    ...
    def size(self, flags: int, str: str, tabstops: int = ..., tabarray: Optional[object] = ...) -> PySide6.QtCore.QSize: ...
...
class QFontMetricsF(Shiboken.Object):
    ...
    @overload
    def boundingRect(self, r: Union[PySide6.QtCore.QRectF, PySide6.QtCore.QRect], flags: int, string: str, tabstops: int = ..., tabarray: Optional[object] = ...) -> PySide6.QtCore.QRectF: ...
    @overload
    ...
    def size(self, flags: int, str: str, tabstops: int = ..., tabarray: Optional[object] = ...) -> PySide6.QtCore.QSizeF: ...
...
class QGradient(Shiboken.Object):
    ...
    def setColorAt(self, pos: float, color: Union[PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, Any, PySide6.QtCore.Qt.GlobalColor, int]) -> None: ...
...
class QGuiApplication(PySide6.QtCore.QCoreApplication):
    ...
    @staticmethod
    def platformFunction(function: Union[PySide6.QtCore.QByteArray, bytes, bytearray, memoryview]) -> int: ...
    @staticmethod
...
class QIcon(Shiboken.Object):
    ...
    class ThemeIcon(enum.Enum):
        ...
        AddressBookNew           : QIcon.ThemeIcon = ... # 0x0
        ApplicationExit          : QIcon.ThemeIcon = ... # 0x1
        AppointmentNew           : QIcon.ThemeIcon = ... # 0x2
        CallStart                : QIcon.ThemeIcon = ... # 0x3
        CallStop                 : QIcon.ThemeIcon = ... # 0x4
        ContactNew               : QIcon.ThemeIcon = ... # 0x5
        DocumentNew              : QIcon.ThemeIcon = ... # 0x6
        DocumentOpen             : QIcon.ThemeIcon = ... # 0x7
        DocumentOpenRecent       : QIcon.ThemeIcon = ... # 0x8
        DocumentPageSetup        : QIcon.ThemeIcon = ... # 0x9
        DocumentPrint            : QIcon.ThemeIcon = ... # 0xa
        DocumentPrintPreview     : QIcon.ThemeIcon = ... # 0xb
        DocumentProperties       : QIcon.ThemeIcon = ... # 0xc
        DocumentRevert           : QIcon.ThemeIcon = ... # 0xd
        DocumentSave             : QIcon.ThemeIcon = ... # 0xe
        DocumentSaveAs           : QIcon.ThemeIcon = ... # 0xf
        DocumentSend             : QIcon.ThemeIcon = ... # 0x10
        EditClear                : QIcon.ThemeIcon = ... # 0x11
        EditCopy                 : QIcon.ThemeIcon = ... # 0x12
        EditCut                  : QIcon.ThemeIcon = ... # 0x13
        EditDelete               : QIcon.ThemeIcon = ... # 0x14
        EditFind                 : QIcon.ThemeIcon = ... # 0x15
        EditPaste                : QIcon.ThemeIcon = ... # 0x16
        EditRedo                 : QIcon.ThemeIcon = ... # 0x17
        EditSelectAll            : QIcon.ThemeIcon = ... # 0x18
        EditUndo                 : QIcon.ThemeIcon = ... # 0x19
        FolderNew                : QIcon.ThemeIcon = ... # 0x1a
        FormatIndentLess         : QIcon.ThemeIcon = ... # 0x1b
        FormatIndentMore         : QIcon.ThemeIcon = ... # 0x1c
        FormatJustifyCenter      : QIcon.ThemeIcon = ... # 0x1d
        FormatJustifyFill        : QIcon.ThemeIcon = ... # 0x1e
        FormatJustifyLeft        : QIcon.ThemeIcon = ... # 0x1f
        FormatJustifyRight       : QIcon.ThemeIcon = ... # 0x20
        FormatTextDirectionLtr   : QIcon.ThemeIcon = ... # 0x21
        FormatTextDirectionRtl   : QIcon.ThemeIcon = ... # 0x22
        FormatTextBold           : QIcon.ThemeIcon = ... # 0x23
        FormatTextItalic         : QIcon.ThemeIcon = ... # 0x24
        FormatTextUnderline      : QIcon.ThemeIcon = ... # 0x25
        FormatTextStrikethrough  : QIcon.ThemeIcon = ... # 0x26
        GoDown                   : QIcon.ThemeIcon = ... # 0x27
        GoHome                   : QIcon.ThemeIcon = ... # 0x28
        GoNext                   : QIcon.ThemeIcon = ... # 0x29
        GoPrevious               : QIcon.ThemeIcon = ... # 0x2a
        GoUp                     : QIcon.ThemeIcon = ... # 0x2b
        HelpAbout                : QIcon.ThemeIcon = ... # 0x2c
        HelpFaq                  : QIcon.ThemeIcon = ... # 0x2d
        InsertImage              : QIcon.ThemeIcon = ... # 0x2e
        InsertLink               : QIcon.ThemeIcon = ... # 0x2f
        InsertText               : QIcon.ThemeIcon = ... # 0x30
        ListAdd                  : QIcon.ThemeIcon = ... # 0x31
        ListRemove               : QIcon.ThemeIcon = ... # 0x32
        MailForward              : QIcon.ThemeIcon = ... # 0x33
        MailMarkImportant        : QIcon.ThemeIcon = ... # 0x34
        MailMarkRead             : QIcon.ThemeIcon = ... # 0x35
        MailMarkUnread           : QIcon.ThemeIcon = ... # 0x36
        MailMessageNew           : QIcon.ThemeIcon = ... # 0x37
        MailReplyAll             : QIcon.ThemeIcon = ... # 0x38
        MailReplySender          : QIcon.ThemeIcon = ... # 0x39
        MailSend                 : QIcon.ThemeIcon = ... # 0x3a
        MediaEject               : QIcon.ThemeIcon = ... # 0x3b
        MediaPlaybackPause       : QIcon.ThemeIcon = ... # 0x3c
        MediaPlaybackStart       : QIcon.ThemeIcon = ... # 0x3d
        MediaPlaybackStop        : QIcon.ThemeIcon = ... # 0x3e
        MediaRecord              : QIcon.ThemeIcon = ... # 0x3f
        MediaSeekBackward        : QIcon.ThemeIcon = ... # 0x40
        MediaSeekForward         : QIcon.ThemeIcon = ... # 0x41
        MediaSkipBackward        : QIcon.ThemeIcon = ... # 0x42
        MediaSkipForward         : QIcon.ThemeIcon = ... # 0x43
        ObjectRotateLeft         : QIcon.ThemeIcon = ... # 0x44
        ObjectRotateRight        : QIcon.ThemeIcon = ... # 0x45
        ProcessStop              : QIcon.ThemeIcon = ... # 0x46
        SystemLockScreen         : QIcon.ThemeIcon = ... # 0x47
        SystemLogOut             : QIcon.ThemeIcon = ... # 0x48
        SystemSearch             : QIcon.ThemeIcon = ... # 0x49
        SystemReboot             : QIcon.ThemeIcon = ... # 0x4a
        SystemShutdown           : QIcon.ThemeIcon = ... # 0x4b
        ToolsCheckSpelling       : QIcon.ThemeIcon = ... # 0x4c
        ViewFullscreen           : QIcon.ThemeIcon = ... # 0x4d
        ViewRefresh              : QIcon.ThemeIcon = ... # 0x4e
        ViewRestore              : QIcon.ThemeIcon = ... # 0x4f
        WindowClose              : QIcon.ThemeIcon = ... # 0x50
        WindowNew                : QIcon.ThemeIcon = ... # 0x51
        ZoomFitBest              : QIcon.ThemeIcon = ... # 0x52
        ZoomIn                   : QIcon.ThemeIcon = ... # 0x53
        ZoomOut                  : QIcon.ThemeIcon = ... # 0x54
        AudioCard                : QIcon.ThemeIcon = ... # 0x55
        AudioInputMicrophone     : QIcon.ThemeIcon = ... # 0x56
        Battery                  : QIcon.ThemeIcon = ... # 0x57
        CameraPhoto              : QIcon.ThemeIcon = ... # 0x58
        CameraVideo              : QIcon.ThemeIcon = ... # 0x59
        CameraWeb                : QIcon.ThemeIcon = ... # 0x5a
        Computer                 : QIcon.ThemeIcon = ... # 0x5b
        DriveHarddisk            : QIcon.ThemeIcon = ... # 0x5c
        DriveOptical             : QIcon.ThemeIcon = ... # 0x5d
        InputGaming              : QIcon.ThemeIcon = ... # 0x5e
        InputKeyboard            : QIcon.ThemeIcon = ... # 0x5f
        InputMouse               : QIcon.ThemeIcon = ... # 0x60
        InputTablet              : QIcon.ThemeIcon = ... # 0x61
        MediaFlash               : QIcon.ThemeIcon = ... # 0x62
        MediaOptical             : QIcon.ThemeIcon = ... # 0x63
        MediaTape                : QIcon.ThemeIcon = ... # 0x64
        MultimediaPlayer         : QIcon.ThemeIcon = ... # 0x65
        NetworkWired             : QIcon.ThemeIcon = ... # 0x66
        NetworkWireless          : QIcon.ThemeIcon = ... # 0x67
        Phone                    : QIcon.ThemeIcon = ... # 0x68
        Printer                  : QIcon.ThemeIcon = ... # 0x69
        Scanner                  : QIcon.ThemeIcon = ... # 0x6a
        VideoDisplay             : QIcon.ThemeIcon = ... # 0x6b
        AppointmentMissed        : QIcon.ThemeIcon = ... # 0x6c
        AppointmentSoon          : QIcon.ThemeIcon = ... # 0x6d
        AudioVolumeHigh          : QIcon.ThemeIcon = ... # 0x6e
        AudioVolumeLow           : QIcon.ThemeIcon = ... # 0x6f
        AudioVolumeMedium        : QIcon.ThemeIcon = ... # 0x70
        AudioVolumeMuted         : QIcon.ThemeIcon = ... # 0x71
        BatteryCaution           : QIcon.ThemeIcon = ... # 0x72
        BatteryLow               : QIcon.ThemeIcon = ... # 0x73
        DialogError              : QIcon.ThemeIcon = ... # 0x74
        DialogInformation        : QIcon.ThemeIcon = ... # 0x75
        DialogPassword           : QIcon.ThemeIcon = ... # 0x76
        DialogQuestion           : QIcon.ThemeIcon = ... # 0x77
        DialogWarning            : QIcon.ThemeIcon = ... # 0x78
        FolderDragAccept         : QIcon.ThemeIcon = ... # 0x79
        FolderOpen               : QIcon.ThemeIcon = ... # 0x7a
        FolderVisiting           : QIcon.ThemeIcon = ... # 0x7b
        ImageLoading             : QIcon.ThemeIcon = ... # 0x7c
        ImageMissing             : QIcon.ThemeIcon = ... # 0x7d
        MailAttachment           : QIcon.ThemeIcon = ... # 0x7e
        MailUnread               : QIcon.ThemeIcon = ... # 0x7f
        MailRead                 : QIcon.ThemeIcon = ... # 0x80
        MailReplied              : QIcon.ThemeIcon = ... # 0x81
        MediaPlaylistRepeat      : QIcon.ThemeIcon = ... # 0x82
        MediaPlaylistShuffle     : QIcon.ThemeIcon = ... # 0x83
        NetworkOffline           : QIcon.ThemeIcon = ... # 0x84
        PrinterPrinting          : QIcon.ThemeIcon = ... # 0x85
        SecurityHigh             : QIcon.ThemeIcon = ... # 0x86
        SecurityLow              : QIcon.ThemeIcon = ... # 0x87
        SoftwareUpdateAvailable  : QIcon.ThemeIcon = ... # 0x88
        SoftwareUpdateUrgent     : QIcon.ThemeIcon = ... # 0x89
        SyncError                : QIcon.ThemeIcon = ... # 0x8a
        SyncSynchronizing        : QIcon.ThemeIcon = ... # 0x8b
        UserAvailable            : QIcon.ThemeIcon = ... # 0x8c
        UserOffline              : QIcon.ThemeIcon = ... # 0x8d
        WeatherClear             : QIcon.ThemeIcon = ... # 0x8e
        WeatherClearNight        : QIcon.ThemeIcon = ... # 0x8f
        WeatherFewClouds         : QIcon.ThemeIcon = ... # 0x90
        WeatherFewCloudsNight    : QIcon.ThemeIcon = ... # 0x91
        WeatherFog               : QIcon.ThemeIcon = ... # 0x92
        WeatherShowers           : QIcon.ThemeIcon = ... # 0x93
        WeatherSnow              : QIcon.ThemeIcon = ... # 0x94
        WeatherStorm             : QIcon.ThemeIcon = ... # 0x95
        NThemeIcons              : QIcon.ThemeIcon = ... # 0x96
    ...
    @overload
    def addPixmap(self, path: Union[str, bytes, os.PathLike[str]]) -> None: ...
    @overload
    def addPixmap(self, pixmap: Union[PySide6.QtGui.QPixmap, PySide6.QtGui.QImage], mode: PySide6.QtGui.QIcon.Mode = ..., state: PySide6.QtGui.QIcon.State = ...) -> None: ...
    ...
    @overload
    @staticmethod
    def fromTheme(icon: PySide6.QtGui.QIcon.ThemeIcon, fallback: Union[PySide6.QtGui.QIcon, PySide6.QtGui.QPixmap]) -> PySide6.QtGui.QIcon: ...
    @overload
    @staticmethod
...
class QImage(PySide6.QtGui.QPaintDevice):
    ...
    @overload
    def __init__(self, data: Union[bytes, bytearray, memoryview], width: int, height: int, bytesPerLine: int, format: PySide6.QtGui.QImage.Format, cleanupFunction: Optional[Callable] = ..., cleanupInfo: Optional[int] = ...) -> None: ...
    @overload
    def __init__(self, data: Union[bytes, bytearray, memoryview], width: int, height: int, format: PySide6.QtGui.QImage.Format, cleanupFunction: Optional[Callable] = ..., cleanupInfo: Optional[int] = ...) -> None: ...
    @overload
    def __init__(self, fileName: Union[str, bytes, os.PathLike[str]], format: Union[bytes, bytearray, memoryview, NoneType] = ...) -> None: ...
    @overload
    ...
    def bits(self) -> Union[bytes, bytearray, memoryview]: ...
    ...
    def constBits(self) -> Union[bytes, bytearray, memoryview]: ...
    ...
    @overload
    def fill(self, color: Union[PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, Any, PySide6.QtCore.Qt.GlobalColor, int]) -> None: ...
    @overload
    def fill(self, pixel: int) -> None: ...
    def format(self) -> PySide6.QtGui.QImage.Format: ...
    @staticmethod
    def fromData(data: Union[PySide6.QtCore.QByteArray, bytes, bytearray, memoryview], format: Union[bytes, bytearray, memoryview, NoneType] = ...) -> PySide6.QtGui.QImage: ...
    ...
    def isNull(self) -> bool: ...
    @overload
    def load(self, device: PySide6.QtCore.QIODevice, format: Union[bytes, bytearray, memoryview]) -> bool: ...
    @overload
    def load(self, fileName: str, format: Union[bytes, bytearray, memoryview, NoneType] = ...) -> bool: ...
    def loadFromData(self, data: Union[PySide6.QtCore.QByteArray, bytes, bytearray, memoryview], format: Union[bytes, bytearray, memoryview, NoneType] = ...) -> bool: ...
    ...
    @overload
    def save(self, device: PySide6.QtCore.QIODevice, format: Union[bytes, bytearray, memoryview, NoneType] = ..., quality: int = ...) -> bool: ...
    @overload
    def save(self, fileName: str, format: Union[bytes, bytearray, memoryview, NoneType] = ..., quality: int = ...) -> bool: ...
    @overload
    ...
    @overload
    def setPixelColor(self, pt: PySide6.QtCore.QPoint, c: Union[PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, Any, PySide6.QtCore.Qt.GlobalColor, int]) -> None: ...
    @overload
    def setPixelColor(self, x: int, y: int, c: Union[PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, Any, PySide6.QtCore.Qt.GlobalColor, int]) -> None: ...
...
class QImageIOHandler(Shiboken.Object):
    ...
    def setFormat(self, format: Union[PySide6.QtCore.QByteArray, bytes, bytearray, memoryview]) -> None: ...
...
class QImageReader(Shiboken.Object):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, device: PySide6.QtCore.QIODevice, format: Union[PySide6.QtCore.QByteArray, bytes, bytearray, memoryview] = ...) -> None: ...
    @overload
    def __init__(self, fileName: str, format: Union[PySide6.QtCore.QByteArray, bytes, bytearray, memoryview] = ...) -> None: ...
    ...
    @staticmethod
    def imageFormatsForMimeType(mimeType: Union[PySide6.QtCore.QByteArray, bytes, bytearray, memoryview]) -> List[PySide6.QtCore.QByteArray]: ...
    def jumpToImage(self, imageNumber: int) -> bool: ...
    def jumpToNextImage(self) -> bool: ...
    def loopCount(self) -> int: ...
    def nextImageDelay(self) -> int: ...
...
class QImageWriter(Shiboken.Object):
    ...
    def setQuality(self, quality: int) -> None: ...
    def setSubType(self, type: Union[PySide6.QtCore.QByteArray, bytes, bytearray, memoryview]) -> None: ...
...
class QMovie(PySide6.QtCore.QObject):
    ...
    @overload
    def __init__(self, device: PySide6.QtCore.QIODevice, format: Union[PySide6.QtCore.QByteArray, bytes, bytearray, memoryview] = ..., parent: Optional[PySide6.QtCore.QObject] = ...) -> None: ...
    @overload
    def __init__(self, fileName: str, format: Union[PySide6.QtCore.QByteArray, bytes, bytearray, memoryview] = ..., parent: Optional[PySide6.QtCore.QObject] = ...) -> None: ...
    @overload
    def __init__(self, parent: Optional[PySide6.QtCore.QObject] = ...) -> None: ...
...
class QOpenGLContext(PySide6.QtCore.QObject):
    ...
    @overload
    def getProcAddress(self, procName: Union[bytes, bytearray, memoryview]) -> int: ...
    @overload
    def getProcAddress(self, procName: Union[PySide6.QtCore.QByteArray, bytes, bytearray, memoryview]) -> int: ...
    @staticmethod
    def globalShareContext() -> PySide6.QtGui.QOpenGLContext: ...
    def hasExtension(self, extension: Union[PySide6.QtCore.QByteArray, bytes, bytearray, memoryview]) -> bool: ...
...
class QOpenGLExtraFunctions(PySide6.QtGui.QOpenGLFunctions):
    ...
    def glDebugMessageInsert(self, source: int, type: int, id: int, severity: int, length: int, buf: Union[bytes, bytearray, memoryview]) -> None: ...
    ...
    def glGetFragDataLocation(self, program: int, name: Union[bytes, bytearray, memoryview]) -> int: ...
    ...
    def glGetProgramResourceIndex(self, program: int, programInterface: int, name: Union[bytes, bytearray, memoryview]) -> int: ...
    def glGetProgramResourceLocation(self, program: int, programInterface: int, name: Union[bytes, bytearray, memoryview]) -> int: ...
    ...
    def glGetUniformBlockIndex(self, program: int, uniformBlockName: Union[bytes, bytearray, memoryview]) -> int: ...
    ...
    def glObjectLabel(self, identifier: int, name: int, length: int, label: Union[bytes, bytearray, memoryview]) -> None: ...
    def glObjectPtrLabel(self, ptr: int, length: int, label: Union[bytes, bytearray, memoryview]) -> None: ...
    ...
    def glPushDebugGroup(self, source: int, id: int, length: int, message: Union[bytes, bytearray, memoryview]) -> None: ...
...
class QOpenGLFunctions(Shiboken.Object):
    ...
    def glBindAttribLocation(self, program: int, index: int, name: Union[bytes, bytearray, memoryview]) -> None: ...
    ...
    def glGetAttribLocation(self, program: int, name: Union[bytes, bytearray, memoryview]) -> int: ...
    ...
    def glGetShaderSource(self, shader: int) -> Union[bytes, bytearray, memoryview]: ...
    ...
    def glGetUniformLocation(self, program: int, name: Union[bytes, bytearray, memoryview]) -> int: ...
...
class QPaintEngine(Shiboken.Object):
    ...
    def drawImage(self, r: Union[PySide6.QtCore.QRectF, PySide6.QtCore.QRect], pm: PySide6.QtGui.QImage, sr: Union[PySide6.QtCore.QRectF, PySide6.QtCore.QRect], flags: PySide6.QtCore.Qt.ImageConversionFlag = ...) -> None: ...
    @overload
    ...
    def drawPixmap(self, r: Union[PySide6.QtCore.QRectF, PySide6.QtCore.QRect], pm: Union[PySide6.QtGui.QPixmap, PySide6.QtGui.QImage], sr: Union[PySide6.QtCore.QRectF, PySide6.QtCore.QRect]) -> None: ...
    @overload
    ...
    def drawTiledPixmap(self, r: Union[PySide6.QtCore.QRectF, PySide6.QtCore.QRect], pixmap: Union[PySide6.QtGui.QPixmap, PySide6.QtGui.QImage], s: Union[PySide6.QtCore.QPointF, PySide6.QtCore.QPoint, PySide6.QtGui.QPainterPath.Element]) -> None: ...
    def end(self) -> bool: ...
...
class QPainter(Shiboken.Object):
    ...
    @overload
    def drawImage(self, p: Union[PySide6.QtCore.QPointF, PySide6.QtCore.QPoint, PySide6.QtGui.QPainterPath.Element], image: PySide6.QtGui.QImage) -> None: ...
    @overload
    def drawImage(self, p: Union[PySide6.QtCore.QPointF, PySide6.QtCore.QPoint, PySide6.QtGui.QPainterPath.Element], image: PySide6.QtGui.QImage, sr: Union[PySide6.QtCore.QRectF, PySide6.QtCore.QRect], flags: PySide6.QtCore.Qt.ImageConversionFlag = ...) -> None: ...
    @overload
    def drawImage(self, r: PySide6.QtCore.QRect, image: PySide6.QtGui.QImage) -> None: ...
    @overload
    def drawImage(self, r: Union[PySide6.QtCore.QRectF, PySide6.QtCore.QRect], image: PySide6.QtGui.QImage) -> None: ...
    @overload
    ...
    @overload
    def drawImage(self, targetRect: Union[PySide6.QtCore.QRectF, PySide6.QtCore.QRect], image: PySide6.QtGui.QImage, sourceRect: Union[PySide6.QtCore.QRectF, PySide6.QtCore.QRect], flags: PySide6.QtCore.Qt.ImageConversionFlag = ...) -> None: ...
    @overload
    def drawImage(self, x: int, y: int, image: PySide6.QtGui.QImage, sx: int = ..., sy: int = ..., sw: int = ..., sh: int = ..., flags: PySide6.QtCore.Qt.ImageConversionFlag = ...) -> None: ...
    @overload
    ...
    @overload
    def drawPixmap(self, p: PySide6.QtCore.QPoint, pm: Union[PySide6.QtGui.QPixmap, PySide6.QtGui.QImage]) -> None: ...
    @overload
    def drawPixmap(self, p: PySide6.QtCore.QPoint, pm: Union[PySide6.QtGui.QPixmap, PySide6.QtGui.QImage], sr: PySide6.QtCore.QRect) -> None: ...
    @overload
    def drawPixmap(self, p: Union[PySide6.QtCore.QPointF, PySide6.QtCore.QPoint, PySide6.QtGui.QPainterPath.Element], pm: Union[PySide6.QtGui.QPixmap, PySide6.QtGui.QImage]) -> None: ...
    @overload
    def drawPixmap(self, p: Union[PySide6.QtCore.QPointF, PySide6.QtCore.QPoint, PySide6.QtGui.QPainterPath.Element], pm: Union[PySide6.QtGui.QPixmap, PySide6.QtGui.QImage], sr: Union[PySide6.QtCore.QRectF, PySide6.QtCore.QRect]) -> None: ...
    @overload
    def drawPixmap(self, r: PySide6.QtCore.QRect, pm: Union[PySide6.QtGui.QPixmap, PySide6.QtGui.QImage]) -> None: ...
    @overload
    def drawPixmap(self, targetRect: PySide6.QtCore.QRect, pixmap: Union[PySide6.QtGui.QPixmap, PySide6.QtGui.QImage], sourceRect: PySide6.QtCore.QRect) -> None: ...
    @overload
    def drawPixmap(self, targetRect: Union[PySide6.QtCore.QRectF, PySide6.QtCore.QRect], pixmap: Union[PySide6.QtGui.QPixmap, PySide6.QtGui.QImage], sourceRect: Union[PySide6.QtCore.QRectF, PySide6.QtCore.QRect]) -> None: ...
    @overload
    def drawPixmap(self, x: int, y: int, pm: Union[PySide6.QtGui.QPixmap, PySide6.QtGui.QImage]) -> None: ...
    @overload
    def drawPixmap(self, x: int, y: int, pm: Union[PySide6.QtGui.QPixmap, PySide6.QtGui.QImage], sx: int, sy: int, sw: int, sh: int) -> None: ...
    @overload
    def drawPixmap(self, x: int, y: int, w: int, h: int, pm: Union[PySide6.QtGui.QPixmap, PySide6.QtGui.QImage]) -> None: ...
    @overload
    def drawPixmap(self, x: int, y: int, w: int, h: int, pm: Union[PySide6.QtGui.QPixmap, PySide6.QtGui.QImage], sx: int, sy: int, sw: int, sh: int) -> None: ...
    def drawPixmapFragments(self, fragments: PySide6.QtGui.QPainter.PixmapFragment, fragmentCount: int, pixmap: Union[PySide6.QtGui.QPixmap, PySide6.QtGui.QImage], hints: PySide6.QtGui.QPainter.PixmapFragmentHint = ...) -> None: ...
    @overload
    ...
    @overload
    def drawTiledPixmap(self, arg__1: PySide6.QtCore.QRect, arg__2: Union[PySide6.QtGui.QPixmap, PySide6.QtGui.QImage], pos: PySide6.QtCore.QPoint = ...) -> None: ...
    @overload
    def drawTiledPixmap(self, rect: Union[PySide6.QtCore.QRectF, PySide6.QtCore.QRect], pm: Union[PySide6.QtGui.QPixmap, PySide6.QtGui.QImage], offset: Union[PySide6.QtCore.QPointF, PySide6.QtCore.QPoint, PySide6.QtGui.QPainterPath.Element] = ...) -> None: ...
    @overload
    def drawTiledPixmap(self, x: int, y: int, w: int, h: int, arg__5: Union[PySide6.QtGui.QPixmap, PySide6.QtGui.QImage], sx: int = ..., sy: int = ...) -> None: ...
    def end(self) -> bool: ...
    ...
    @overload
    def fillRect(self, arg__1: PySide6.QtCore.QRect, color: Union[PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, Any, PySide6.QtCore.Qt.GlobalColor, int]) -> None: ...
    @overload
    ...
    @overload
    def fillRect(self, arg__1: Union[PySide6.QtCore.QRectF, PySide6.QtCore.QRect], color: Union[PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, Any, PySide6.QtCore.Qt.GlobalColor, int]) -> None: ...
    @overload
    ...
    @overload
    def fillRect(self, x: int, y: int, w: int, h: int, color: Union[PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, Any, PySide6.QtCore.Qt.GlobalColor, int]) -> None: ...
    @overload
    ...
    @overload
    def setPen(self, color: Union[PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, Any, PySide6.QtCore.Qt.GlobalColor, int]) -> None: ...
    @overload
...
class QPalette(Shiboken.Object):
    ...
    @overload
    def __init__(self, button: Union[PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, Any, PySide6.QtCore.Qt.GlobalColor, int]) -> None: ...
    @overload
    def __init__(self, button: Union[PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, Any, PySide6.QtCore.Qt.GlobalColor, int], window: Union[PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, Any, PySide6.QtCore.Qt.GlobalColor, int]) -> None: ...
    @overload
    ...
    @overload
    def __init__(self, windowText: Union[PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, Any, PySide6.QtCore.Qt.GlobalColor, int], window: Union[PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, Any, PySide6.QtCore.Qt.GlobalColor, int], light: Union[PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, Any, PySide6.QtCore.Qt.GlobalColor, int], dark: Union[PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, Any, PySide6.QtCore.Qt.GlobalColor, int], mid: Union[PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, Any, PySide6.QtCore.Qt.GlobalColor, int], text: Union[PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, Any, PySide6.QtCore.Qt.GlobalColor, int], base: Union[PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, Any, PySide6.QtCore.Qt.GlobalColor, int]) -> None: ...
    ...
    @overload
    def setColor(self, cg: PySide6.QtGui.QPalette.ColorGroup, cr: PySide6.QtGui.QPalette.ColorRole, color: Union[PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, Any, PySide6.QtCore.Qt.GlobalColor, int]) -> None: ...
    @overload
    def setColor(self, cr: PySide6.QtGui.QPalette.ColorRole, color: Union[PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, Any, PySide6.QtCore.Qt.GlobalColor, int]) -> None: ...
...
class QPdfWriter(PySide6.QtCore.QObject, PySide6.QtGui.QPagedPaintDevice):
    ...
    def addFileAttachment(self, fileName: str, data: Union[PySide6.QtCore.QByteArray, bytes, bytearray, memoryview], mimeType: str = ...) -> None: ...
    ...
    def setDocumentXmpMetadata(self, xmpMetadata: Union[PySide6.QtCore.QByteArray, bytes, bytearray, memoryview]) -> None: ...
...
class QPen(Shiboken.Object):
    ...
    @overload
    def __init__(self, color: Union[PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, Any, PySide6.QtCore.Qt.GlobalColor, int]) -> None: ...
    @overload
    def __init__(self, pen: Union[PySide6.QtGui.QPen, PySide6.QtCore.Qt.PenStyle, PySide6.QtGui.QColor]) -> None: ...
...
class QPicture(PySide6.QtGui.QPaintDevice):
    ...
    def setData(self, data: Union[bytes, bytearray, memoryview]) -> None: ...
    def size(self) -> int: ...
...
class QPixmap(PySide6.QtGui.QPaintDevice):
    ...
    def __init__(self, arg__1: Union[PySide6.QtGui.QPixmap, PySide6.QtGui.QImage]) -> None: ...
    @overload
    def __init__(self, fileName: Union[str, bytes, os.PathLike[str]], format: Union[bytes, bytearray, memoryview, NoneType] = ..., flags: PySide6.QtCore.Qt.ImageConversionFlag = ...) -> None: ...
    @overload
    def __init__(self, image: PySide6.QtGui.QImage) -> None: ...
    @overload
    def __init__(self, w: int, h: int) -> None: ...
    ...
    def createMaskFromColor(self, maskColor: Union[PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, Any, PySide6.QtCore.Qt.GlobalColor, int], mode: PySide6.QtCore.Qt.MaskMode = ...) -> PySide6.QtGui.QBitmap: ...
    @staticmethod
    ...
    def deviceIndependentSize(self) -> PySide6.QtCore.QSizeF: ...
    def devicePixelRatio(self) -> float: ...
    def fill(self, fillColor: Union[PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, Any, PySide6.QtCore.Qt.GlobalColor, int] = ...) -> None: ...
    @staticmethod
    ...
    def size(self) -> PySide6.QtCore.QSize: ...
    def swap(self, other: Union[PySide6.QtGui.QPixmap, PySide6.QtGui.QImage]) -> None: ...
...
class QPixmapCache(Shiboken.Object):
    ...
    @overload
    @staticmethod
    def find(key: PySide6.QtGui.QPixmapCache.Key, pixmap: Union[PySide6.QtGui.QPixmap, PySide6.QtGui.QImage]) -> bool: ...
    @overload
    @staticmethod
    def find(key: str, pixmap: Union[PySide6.QtGui.QPixmap, PySide6.QtGui.QImage]) -> bool: ...
    @overload
    ...
    @overload
    @staticmethod
    def insert(key: str, pixmap: Union[PySide6.QtGui.QPixmap, PySide6.QtGui.QImage]) -> bool: ...
    @overload
    @staticmethod
    def insert(pixmap: Union[PySide6.QtGui.QPixmap, PySide6.QtGui.QImage]) -> PySide6.QtGui.QPixmapCache.Key: ...
    @overload
    @staticmethod
    ...
    @staticmethod
    def replace(key: PySide6.QtGui.QPixmapCache.Key, pixmap: Union[PySide6.QtGui.QPixmap, PySide6.QtGui.QImage]) -> bool: ...
    @staticmethod
...
class QQuaternion(Shiboken.Object):
    ...
    def getAxisAndAngle(self) -> Tuple[PySide6.QtGui.QVector3D, float]: ...
...
class QRawFont(Shiboken.Object):
    ...
    @overload
    def __init__(self, fontData: Union[PySide6.QtCore.QByteArray, bytes, bytearray, memoryview], pixelSize: float, hintingPreference: PySide6.QtGui.QFont.HintingPreference = ...) -> None: ...
    @overload
    ...
    @overload
    def fontTable(self, tag: PySide6.QtGui.QFont.Tag) -> PySide6.QtCore.QByteArray: ...
    @overload
    def fontTable(self, tagName: Union[bytes, bytearray, memoryview]) -> PySide6.QtCore.QByteArray: ...
    @staticmethod
    ...
    def loadFromData(self, fontData: Union[PySide6.QtCore.QByteArray, bytes, bytearray, memoryview], pixelSize: float, hintingPreference: PySide6.QtGui.QFont.HintingPreference) -> None: ...
...
class QRhi(Shiboken.Object):
    ...
    class Feature(enum.Enum):
        ...
        MultisampleTexture       : QRhi.Feature = ... # 0x1
        MultisampleRenderBuffer  : QRhi.Feature = ... # 0x2
        DebugMarkers             : QRhi.Feature = ... # 0x3
        Timestamps               : QRhi.Feature = ... # 0x4
        Instancing               : QRhi.Feature = ... # 0x5
        CustomInstanceStepRate   : QRhi.Feature = ... # 0x6
        PrimitiveRestart         : QRhi.Feature = ... # 0x7
        NonDynamicUniformBuffers : QRhi.Feature = ... # 0x8
        NonFourAlignedEffectiveIndexBufferOffset: QRhi.Feature = ... # 0x9
        NPOTTextureRepeat        : QRhi.Feature = ... # 0xa
        RedOrAlpha8IsRed         : QRhi.Feature = ... # 0xb
        ElementIndexUint         : QRhi.Feature = ... # 0xc
        Compute                  : QRhi.Feature = ... # 0xd
        WideLines                : QRhi.Feature = ... # 0xe
        VertexShaderPointSize    : QRhi.Feature = ... # 0xf
        BaseVertex               : QRhi.Feature = ... # 0x10
        BaseInstance             : QRhi.Feature = ... # 0x11
        TriangleFanTopology      : QRhi.Feature = ... # 0x12
        ReadBackNonUniformBuffer : QRhi.Feature = ... # 0x13
        ReadBackNonBaseMipLevel  : QRhi.Feature = ... # 0x14
        TexelFetch               : QRhi.Feature = ... # 0x15
        RenderToNonBaseMipLevel  : QRhi.Feature = ... # 0x16
        IntAttributes            : QRhi.Feature = ... # 0x17
        ScreenSpaceDerivatives   : QRhi.Feature = ... # 0x18
        ReadBackAnyTextureFormat : QRhi.Feature = ... # 0x19
        PipelineCacheDataLoadSave: QRhi.Feature = ... # 0x1a
        ImageDataStride          : QRhi.Feature = ... # 0x1b
        RenderBufferImport       : QRhi.Feature = ... # 0x1c
        ThreeDimensionalTextures : QRhi.Feature = ... # 0x1d
        RenderTo3DTextureSlice   : QRhi.Feature = ... # 0x1e
        TextureArrays            : QRhi.Feature = ... # 0x1f
        Tessellation             : QRhi.Feature = ... # 0x20
        GeometryShader           : QRhi.Feature = ... # 0x21
        TextureArrayRange        : QRhi.Feature = ... # 0x22
        NonFillPolygonMode       : QRhi.Feature = ... # 0x23
        OneDimensionalTextures   : QRhi.Feature = ... # 0x24
        OneDimensionalTextureMipmaps: QRhi.Feature = ... # 0x25
        HalfAttributes           : QRhi.Feature = ... # 0x26
        RenderToOneDimensionalTexture: QRhi.Feature = ... # 0x27
        ThreeDimensionalTextureMipmaps: QRhi.Feature = ... # 0x28
        MultiView                : QRhi.Feature = ... # 0x29

    class Flag(enum.Flag):

        EnableDebugMarkers       : QRhi.Flag = ... # 0x1
        PreferSoftwareRenderer   : QRhi.Flag = ... # 0x2
        EnablePipelineCacheDataSave: QRhi.Flag = ... # 0x4
        EnableTimestamps         : QRhi.Flag = ... # 0x8
        SuppressSmokeTestWarnings: QRhi.Flag = ... # 0x10

    class FrameOpResult(enum.Enum):

        FrameOpSuccess           : QRhi.FrameOpResult = ... # 0x0
        FrameOpError             : QRhi.FrameOpResult = ... # 0x1
        FrameOpSwapChainOutOfDate: QRhi.FrameOpResult = ... # 0x2
        FrameOpDeviceLost        : QRhi.FrameOpResult = ... # 0x3

    class Implementation(enum.Enum):

        Null                     : QRhi.Implementation = ... # 0x0
        Vulkan                   : QRhi.Implementation = ... # 0x1
        OpenGLES2                : QRhi.Implementation = ... # 0x2
        D3D11                    : QRhi.Implementation = ... # 0x3
        Metal                    : QRhi.Implementation = ... # 0x4
        D3D12                    : QRhi.Implementation = ... # 0x5

    class ResourceLimit(enum.Enum):

        TextureSizeMin           : QRhi.ResourceLimit = ... # 0x1
        TextureSizeMax           : QRhi.ResourceLimit = ... # 0x2
        MaxColorAttachments      : QRhi.ResourceLimit = ... # 0x3
        FramesInFlight           : QRhi.ResourceLimit = ... # 0x4
        MaxAsyncReadbackFrames   : QRhi.ResourceLimit = ... # 0x5
        MaxThreadGroupsPerDimension: QRhi.ResourceLimit = ... # 0x6
        MaxThreadsPerThreadGroup : QRhi.ResourceLimit = ... # 0x7
        MaxThreadGroupX          : QRhi.ResourceLimit = ... # 0x8
        MaxThreadGroupY          : QRhi.ResourceLimit = ... # 0x9
        MaxThreadGroupZ          : QRhi.ResourceLimit = ... # 0xa
        TextureArraySizeMax      : QRhi.ResourceLimit = ... # 0xb
        MaxUniformBufferRange    : QRhi.ResourceLimit = ... # 0xc
        MaxVertexInputs          : QRhi.ResourceLimit = ... # 0xd
        MaxVertexOutputs         : QRhi.ResourceLimit = ... # 0xe
    ...
    @overload
    @staticmethod
    def backendName(impl: PySide6.QtGui.QRhi.Implementation) -> Union[bytes, bytearray, memoryview]: ...
    @overload
    def backendName(self) -> Union[bytes, bytearray, memoryview]: ...
    ...
    @staticmethod
    def create(impl: PySide6.QtGui.QRhi.Implementation, params: PySide6.QtGui.QRhiInitParams, flags: PySide6.QtGui.QRhi.Flag = ..., importDevice: Optional[PySide6.QtGui.QRhiNativeHandles] = ...) -> PySide6.QtGui.QRhi: ...
    ...
    def newTextureRenderTarget(self, desc: Union[PySide6.QtGui.QRhiTextureRenderTargetDescription, PySide6.QtGui.QRhiColorAttachment], flags: PySide6.QtGui.QRhiTextureRenderTarget.Flag = ...) -> PySide6.QtGui.QRhiTextureRenderTarget: ...
    ...
    def setPipelineCacheData(self, data: Union[PySide6.QtCore.QByteArray, bytes, bytearray, memoryview]) -> None: ...
    @staticmethod
...
class QRhiBuffer(PySide6.QtGui.QRhiResource):
    ...
    class Type(enum.Enum):
        ...
        Immutable                : QRhiBuffer.Type = ... # 0x0
        Static                   : QRhiBuffer.Type = ... # 0x1
        Dynamic                  : QRhiBuffer.Type = ... # 0x2

    class UsageFlag(enum.Flag):

        VertexBuffer             : QRhiBuffer.UsageFlag = ... # 0x1
        IndexBuffer              : QRhiBuffer.UsageFlag = ... # 0x2
        UniformBuffer            : QRhiBuffer.UsageFlag = ... # 0x4
        StorageBuffer            : QRhiBuffer.UsageFlag = ... # 0x8
...
class QRhiColorAttachment(Shiboken.Object):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, QRhiColorAttachment: Union[PySide6.QtGui.QRhiColorAttachment, PySide6.QtGui.QRhiRenderBuffer, PySide6.QtGui.QRhiTexture]) -> None: ...
    @overload
...
class QRhiCommandBuffer(PySide6.QtGui.QRhiResource):
    ...
    class BeginPassFlag(enum.Flag):
        ...
        ExternalContent          : QRhiCommandBuffer.BeginPassFlag = ... # 0x1
        DoNotTrackResourcesForCompute: QRhiCommandBuffer.BeginPassFlag = ... # 0x2

    class IndexFormat(enum.Enum):

        IndexUInt16              : QRhiCommandBuffer.IndexFormat = ... # 0x0
        IndexUInt32              : QRhiCommandBuffer.IndexFormat = ... # 0x1


    def beginComputePass(self, resourceUpdates: Optional[PySide6.QtGui.QRhiResourceUpdateBatch] = ..., flags: PySide6.QtGui.QRhiCommandBuffer.BeginPassFlag = ...) -> None: ...
    def beginExternal(self) -> None: ...
    def beginPass(self, rt: PySide6.QtGui.QRhiRenderTarget, colorClearValue: Union[PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, Any, PySide6.QtCore.Qt.GlobalColor, int], depthStencilClearValue: PySide6.QtGui.QRhiDepthStencilClearValue, resourceUpdates: Optional[PySide6.QtGui.QRhiResourceUpdateBatch] = ..., flags: PySide6.QtGui.QRhiCommandBuffer.BeginPassFlag = ...) -> None: ...
    def debugMarkBegin(self, name: Union[PySide6.QtCore.QByteArray, bytes, bytearray, memoryview]) -> None: ...
    def debugMarkEnd(self) -> None: ...
    def debugMarkMsg(self, msg: Union[PySide6.QtCore.QByteArray, bytes, bytearray, memoryview]) -> None: ...
    def dispatch(self, x: int, y: int, z: int) -> None: ...
    def draw(self, vertexCount: int, instanceCount: int = ..., firstVertex: int = ..., firstInstance: int = ...) -> None: ...
    def drawIndexed(self, indexCount: int, instanceCount: int = ..., firstIndex: int = ..., vertexOffset: int = ..., firstInstance: int = ...) -> None: ...
    def endComputePass(self, resourceUpdates: Optional[PySide6.QtGui.QRhiResourceUpdateBatch] = ...) -> None: ...
    def endExternal(self) -> None: ...
    def endPass(self, resourceUpdates: Optional[PySide6.QtGui.QRhiResourceUpdateBatch] = ...) -> None: ...
    def lastCompletedGpuTime(self) -> float: ...
    def nativeHandles(self) -> PySide6.QtGui.QRhiNativeHandles: ...
    def resourceType(self) -> PySide6.QtGui.QRhiResource.Type: ...
    def resourceUpdate(self, resourceUpdates: PySide6.QtGui.QRhiResourceUpdateBatch) -> None: ...
    def setBlendConstants(self, c: Union[PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, Any, PySide6.QtCore.Qt.GlobalColor, int]) -> None: ...
    ...
    def setShaderResources(self, srb: Optional[PySide6.QtGui.QRhiShaderResourceBindings] = ..., dynamicOffsetCount: int = ..., dynamicOffsets: Optional[Tuple[int, int]] = ...) -> None: ...
    def setStencilRef(self, refValue: int) -> None: ...
    def setVertexInput(self, startBinding: int, bindings: Sequence[Tuple[PySide6.QtGui.QRhiBuffer, int]], indexBuf: Optional[PySide6.QtGui.QRhiBuffer] = ..., indexOffset: int = ..., indexFormat: PySide6.QtGui.QRhiCommandBuffer.IndexFormat = ...) -> None: ...
...
class QRhiComputePipeline(PySide6.QtGui.QRhiResource):
    ...
    class Flag(enum.Flag):
        ...
        CompileShadersWithDebugInfo: QRhiComputePipeline.Flag = ... # 0x1
...
class QRhiDriverInfo(Shiboken.Object):
    ...
    class DeviceType(enum.Enum):
        ...
        UnknownDevice            : QRhiDriverInfo.DeviceType = ... # 0x0
        IntegratedDevice         : QRhiDriverInfo.DeviceType = ... # 0x1
        DiscreteDevice           : QRhiDriverInfo.DeviceType = ... # 0x2
        ExternalDevice           : QRhiDriverInfo.DeviceType = ... # 0x3
        VirtualDevice            : QRhiDriverInfo.DeviceType = ... # 0x4
        CpuDevice                : QRhiDriverInfo.DeviceType = ... # 0x5
...
class QRhiGles2InitParams(PySide6.QtGui.QRhiInitParams):
    ...
    def __copy__() -> None: ...
    @staticmethod
    def newFallbackSurface(format: Union[PySide6.QtGui.QSurfaceFormat, PySide6.QtGui.QSurfaceFormat.FormatOption] = ...) -> PySide6.QtGui.QOffscreenSurface: ...
...
class QRhiGraphicsPipeline(PySide6.QtGui.QRhiResource):
    ...
    class BlendFactor(enum.Enum):
        ...
        Zero                     : QRhiGraphicsPipeline.BlendFactor = ... # 0x0
        One                      : QRhiGraphicsPipeline.BlendFactor = ... # 0x1
        SrcColor                 : QRhiGraphicsPipeline.BlendFactor = ... # 0x2
        OneMinusSrcColor         : QRhiGraphicsPipeline.BlendFactor = ... # 0x3
        DstColor                 : QRhiGraphicsPipeline.BlendFactor = ... # 0x4
        OneMinusDstColor         : QRhiGraphicsPipeline.BlendFactor = ... # 0x5
        SrcAlpha                 : QRhiGraphicsPipeline.BlendFactor = ... # 0x6
        OneMinusSrcAlpha         : QRhiGraphicsPipeline.BlendFactor = ... # 0x7
        DstAlpha                 : QRhiGraphicsPipeline.BlendFactor = ... # 0x8
        OneMinusDstAlpha         : QRhiGraphicsPipeline.BlendFactor = ... # 0x9
        ConstantColor            : QRhiGraphicsPipeline.BlendFactor = ... # 0xa
        OneMinusConstantColor    : QRhiGraphicsPipeline.BlendFactor = ... # 0xb
        ConstantAlpha            : QRhiGraphicsPipeline.BlendFactor = ... # 0xc
        OneMinusConstantAlpha    : QRhiGraphicsPipeline.BlendFactor = ... # 0xd
        SrcAlphaSaturate         : QRhiGraphicsPipeline.BlendFactor = ... # 0xe
        Src1Color                : QRhiGraphicsPipeline.BlendFactor = ... # 0xf
        OneMinusSrc1Color        : QRhiGraphicsPipeline.BlendFactor = ... # 0x10
        Src1Alpha                : QRhiGraphicsPipeline.BlendFactor = ... # 0x11
        OneMinusSrc1Alpha        : QRhiGraphicsPipeline.BlendFactor = ... # 0x12

    class BlendOp(enum.Enum):

        Add                      : QRhiGraphicsPipeline.BlendOp = ... # 0x0
        Subtract                 : QRhiGraphicsPipeline.BlendOp = ... # 0x1
        ReverseSubtract          : QRhiGraphicsPipeline.BlendOp = ... # 0x2
        Min                      : QRhiGraphicsPipeline.BlendOp = ... # 0x3
        Max                      : QRhiGraphicsPipeline.BlendOp = ... # 0x4

    class ColorMaskComponent(enum.Flag):

        R                        : QRhiGraphicsPipeline.ColorMaskComponent = ... # 0x1
        G                        : QRhiGraphicsPipeline.ColorMaskComponent = ... # 0x2
        B                        : QRhiGraphicsPipeline.ColorMaskComponent = ... # 0x4
        A                        : QRhiGraphicsPipeline.ColorMaskComponent = ... # 0x8

    class CompareOp(enum.Enum):

        Never                    : QRhiGraphicsPipeline.CompareOp = ... # 0x0
        Less                     : QRhiGraphicsPipeline.CompareOp = ... # 0x1
        Equal                    : QRhiGraphicsPipeline.CompareOp = ... # 0x2
        LessOrEqual              : QRhiGraphicsPipeline.CompareOp = ... # 0x3
        Greater                  : QRhiGraphicsPipeline.CompareOp = ... # 0x4
        NotEqual                 : QRhiGraphicsPipeline.CompareOp = ... # 0x5
        GreaterOrEqual           : QRhiGraphicsPipeline.CompareOp = ... # 0x6
        Always                   : QRhiGraphicsPipeline.CompareOp = ... # 0x7

    class CullMode(enum.Enum):

        None_                    : QRhiGraphicsPipeline.CullMode = ... # 0x0
        Front                    : QRhiGraphicsPipeline.CullMode = ... # 0x1
        Back                     : QRhiGraphicsPipeline.CullMode = ... # 0x2

    class Flag(enum.Flag):

        UsesBlendConstants       : QRhiGraphicsPipeline.Flag = ... # 0x1
        UsesStencilRef           : QRhiGraphicsPipeline.Flag = ... # 0x2
        UsesScissor              : QRhiGraphicsPipeline.Flag = ... # 0x4
        CompileShadersWithDebugInfo: QRhiGraphicsPipeline.Flag = ... # 0x8

    class FrontFace(enum.Enum):

        CCW                      : QRhiGraphicsPipeline.FrontFace = ... # 0x0
        CW                       : QRhiGraphicsPipeline.FrontFace = ... # 0x1

    class PolygonMode(enum.Enum):

        Fill                     : QRhiGraphicsPipeline.PolygonMode = ... # 0x0
        Line                     : QRhiGraphicsPipeline.PolygonMode = ... # 0x1

    class StencilOp(enum.Enum):

        StencilZero              : QRhiGraphicsPipeline.StencilOp = ... # 0x0
        Keep                     : QRhiGraphicsPipeline.StencilOp = ... # 0x1
        Replace                  : QRhiGraphicsPipeline.StencilOp = ... # 0x2
        IncrementAndClamp        : QRhiGraphicsPipeline.StencilOp = ... # 0x3
        DecrementAndClamp        : QRhiGraphicsPipeline.StencilOp = ... # 0x4
        Invert                   : QRhiGraphicsPipeline.StencilOp = ... # 0x5
        IncrementAndWrap         : QRhiGraphicsPipeline.StencilOp = ... # 0x6
        DecrementAndWrap         : QRhiGraphicsPipeline.StencilOp = ... # 0x7
    ...
    class Topology(enum.Enum):
        ...
        Triangles                : QRhiGraphicsPipeline.Topology = ... # 0x0
        TriangleStrip            : QRhiGraphicsPipeline.Topology = ... # 0x1
        TriangleFan              : QRhiGraphicsPipeline.Topology = ... # 0x2
        Lines                    : QRhiGraphicsPipeline.Topology = ... # 0x3
        LineStrip                : QRhiGraphicsPipeline.Topology = ... # 0x4
        Points                   : QRhiGraphicsPipeline.Topology = ... # 0x5
        Patches                  : QRhiGraphicsPipeline.Topology = ... # 0x6
    ...
    def setShaderResourceBindings(self, srb: PySide6.QtGui.QRhiShaderResourceBindings) -> None: ...
    def setShaderStages(self, stages: Sequence[PySide6.QtGui.QRhiShaderStage]) -> None: ...
    ...
    def setTargetBlends(self, blends: Sequence[PySide6.QtGui.QRhiGraphicsPipeline.TargetBlend]) -> None: ...
...
class QRhiReadbackDescription(Shiboken.Object):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, QRhiReadbackDescription: Union[PySide6.QtGui.QRhiReadbackDescription, PySide6.QtGui.QRhiTexture]) -> None: ...
    @overload
    def __init__(self, texture: PySide6.QtGui.QRhiTexture) -> None: ...
...
class QRhiRenderBuffer(PySide6.QtGui.QRhiResource):
    ...
    class Flag(enum.Flag):
        ...
        UsedWithSwapChainOnly    : QRhiRenderBuffer.Flag = ... # 0x1

    class Type(enum.Enum):

        DepthStencil             : QRhiRenderBuffer.Type = ... # 0x0
        Color                    : QRhiRenderBuffer.Type = ... # 0x1
...
class QRhiResource(Shiboken.Object):
    ...
    class Type(enum.Enum):
        ...
        Buffer                   : QRhiResource.Type = ... # 0x0
        Texture                  : QRhiResource.Type = ... # 0x1
        Sampler                  : QRhiResource.Type = ... # 0x2
        RenderBuffer             : QRhiResource.Type = ... # 0x3
        RenderPassDescriptor     : QRhiResource.Type = ... # 0x4
        SwapChainRenderTarget    : QRhiResource.Type = ... # 0x5
        TextureRenderTarget      : QRhiResource.Type = ... # 0x6
        ShaderResourceBindings   : QRhiResource.Type = ... # 0x7
        GraphicsPipeline         : QRhiResource.Type = ... # 0x8
        SwapChain                : QRhiResource.Type = ... # 0x9
        ComputePipeline          : QRhiResource.Type = ... # 0xa
        CommandBuffer            : QRhiResource.Type = ... # 0xb
    ...
    def setName(self, name: Union[PySide6.QtCore.QByteArray, bytes, bytearray, memoryview]) -> None: ...
...
class QRhiResourceUpdateBatch(Shiboken.Object):
    ...
    def readBackTexture(self, rb: Union[PySide6.QtGui.QRhiReadbackDescription, PySide6.QtGui.QRhiTexture], result: PySide6.QtGui.QRhiReadbackResult) -> None: ...
    ...
    @overload
    def uploadTexture(self, tex: PySide6.QtGui.QRhiTexture, desc: Union[PySide6.QtGui.QRhiTextureUploadDescription, PySide6.QtGui.QRhiTextureUploadEntry]) -> None: ...
    @overload
...
class QRhiSampler(PySide6.QtGui.QRhiResource):
    ...
    class AddressMode(enum.Enum):
        ...
        Repeat                   : QRhiSampler.AddressMode = ... # 0x0
        ClampToEdge              : QRhiSampler.AddressMode = ... # 0x1
        Mirror                   : QRhiSampler.AddressMode = ... # 0x2

    class CompareOp(enum.Enum):

        Never                    : QRhiSampler.CompareOp = ... # 0x0
        Less                     : QRhiSampler.CompareOp = ... # 0x1
        Equal                    : QRhiSampler.CompareOp = ... # 0x2
        LessOrEqual              : QRhiSampler.CompareOp = ... # 0x3
        Greater                  : QRhiSampler.CompareOp = ... # 0x4
        NotEqual                 : QRhiSampler.CompareOp = ... # 0x5
        GreaterOrEqual           : QRhiSampler.CompareOp = ... # 0x6
        Always                   : QRhiSampler.CompareOp = ... # 0x7

    class Filter(enum.Enum):

        None_                    : QRhiSampler.Filter = ... # 0x0
        Nearest                  : QRhiSampler.Filter = ... # 0x1
        Linear                   : QRhiSampler.Filter = ... # 0x2
...
class QRhiShaderResourceBinding(Shiboken.Object):
    ...
    class StageFlag(enum.Flag):
        ...
        VertexStage              : QRhiShaderResourceBinding.StageFlag = ... # 0x1
        TessellationControlStage : QRhiShaderResourceBinding.StageFlag = ... # 0x2
        TessellationEvaluationStage: QRhiShaderResourceBinding.StageFlag = ... # 0x4
        GeometryStage            : QRhiShaderResourceBinding.StageFlag = ... # 0x8
        FragmentStage            : QRhiShaderResourceBinding.StageFlag = ... # 0x10
        ComputeStage             : QRhiShaderResourceBinding.StageFlag = ... # 0x20
    ...
    class Type(enum.Enum):
        ...
        UniformBuffer            : QRhiShaderResourceBinding.Type = ... # 0x0
        SampledTexture           : QRhiShaderResourceBinding.Type = ... # 0x1
        Texture                  : QRhiShaderResourceBinding.Type = ... # 0x2
        Sampler                  : QRhiShaderResourceBinding.Type = ... # 0x3
        ImageLoad                : QRhiShaderResourceBinding.Type = ... # 0x4
        ImageStore               : QRhiShaderResourceBinding.Type = ... # 0x5
        ImageLoadStore           : QRhiShaderResourceBinding.Type = ... # 0x6
        BufferLoad               : QRhiShaderResourceBinding.Type = ... # 0x7
        BufferStore              : QRhiShaderResourceBinding.Type = ... # 0x8
        BufferLoadStore          : QRhiShaderResourceBinding.Type = ... # 0x9
...
class QRhiShaderResourceBindings(PySide6.QtGui.QRhiResource):
    ...
    class UpdateFlag(enum.Flag):
        ...
        BindingsAreSorted        : QRhiShaderResourceBindings.UpdateFlag = ... # 0x1
    ...
    def setBindings(self, bindings: Sequence[PySide6.QtGui.QRhiShaderResourceBinding]) -> None: ...
...
class QRhiShaderStage(Shiboken.Object):
    ...
    class Type(enum.Enum):
        ...
        Vertex                   : QRhiShaderStage.Type = ... # 0x0
        TessellationControl      : QRhiShaderStage.Type = ... # 0x1
        TessellationEvaluation   : QRhiShaderStage.Type = ... # 0x2
        Geometry                 : QRhiShaderStage.Type = ... # 0x3
        Fragment                 : QRhiShaderStage.Type = ... # 0x4
        Compute                  : QRhiShaderStage.Type = ... # 0x5
...
class QRhiSwapChain(PySide6.QtGui.QRhiResource):
    ...
    class Flag(enum.Flag):
        ...
        SurfaceHasPreMulAlpha    : QRhiSwapChain.Flag = ... # 0x1
        SurfaceHasNonPreMulAlpha : QRhiSwapChain.Flag = ... # 0x2
        sRGB                     : QRhiSwapChain.Flag = ... # 0x4
        UsedAsTransferSource     : QRhiSwapChain.Flag = ... # 0x8
        NoVSync                  : QRhiSwapChain.Flag = ... # 0x10
        MinimalBufferCount       : QRhiSwapChain.Flag = ... # 0x20

    class Format(enum.Enum):

        SDR                      : QRhiSwapChain.Format = ... # 0x0
        HDRExtendedSrgbLinear    : QRhiSwapChain.Format = ... # 0x1
        HDR10                    : QRhiSwapChain.Format = ... # 0x2
        HDRExtendedDisplayP3Linear: QRhiSwapChain.Format = ... # 0x3

    class StereoTargetBuffer(enum.Enum):

        LeftBuffer               : QRhiSwapChain.StereoTargetBuffer = ... # 0x0
        RightBuffer              : QRhiSwapChain.StereoTargetBuffer = ... # 0x1
...
class QRhiTexture(PySide6.QtGui.QRhiResource):
    ...
    class Flag(enum.Flag):
        ...
        RenderTarget             : QRhiTexture.Flag = ... # 0x1
        CubeMap                  : QRhiTexture.Flag = ... # 0x4
        MipMapped                : QRhiTexture.Flag = ... # 0x8
        sRGB                     : QRhiTexture.Flag = ... # 0x10
        UsedAsTransferSource     : QRhiTexture.Flag = ... # 0x20
        UsedWithGenerateMips     : QRhiTexture.Flag = ... # 0x40
        UsedWithLoadStore        : QRhiTexture.Flag = ... # 0x80
        UsedAsCompressedAtlas    : QRhiTexture.Flag = ... # 0x100
        ExternalOES              : QRhiTexture.Flag = ... # 0x200
        ThreeDimensional         : QRhiTexture.Flag = ... # 0x400
        TextureRectangleGL       : QRhiTexture.Flag = ... # 0x800
        TextureArray             : QRhiTexture.Flag = ... # 0x1000
        OneDimensional           : QRhiTexture.Flag = ... # 0x2000

    class Format(enum.Enum):

        UnknownFormat            : QRhiTexture.Format = ... # 0x0
        RGBA8                    : QRhiTexture.Format = ... # 0x1
        BGRA8                    : QRhiTexture.Format = ... # 0x2
        R8                       : QRhiTexture.Format = ... # 0x3
        RG8                      : QRhiTexture.Format = ... # 0x4
        R16                      : QRhiTexture.Format = ... # 0x5
        RG16                     : QRhiTexture.Format = ... # 0x6
        RED_OR_ALPHA8            : QRhiTexture.Format = ... # 0x7
        RGBA16F                  : QRhiTexture.Format = ... # 0x8
        RGBA32F                  : QRhiTexture.Format = ... # 0x9
        R16F                     : QRhiTexture.Format = ... # 0xa
        R32F                     : QRhiTexture.Format = ... # 0xb
        RGB10A2                  : QRhiTexture.Format = ... # 0xc
        D16                      : QRhiTexture.Format = ... # 0xd
        D24                      : QRhiTexture.Format = ... # 0xe
        D24S8                    : QRhiTexture.Format = ... # 0xf
        D32F                     : QRhiTexture.Format = ... # 0x10
        BC1                      : QRhiTexture.Format = ... # 0x11
        BC2                      : QRhiTexture.Format = ... # 0x12
        BC3                      : QRhiTexture.Format = ... # 0x13
        BC4                      : QRhiTexture.Format = ... # 0x14
        BC5                      : QRhiTexture.Format = ... # 0x15
        BC6H                     : QRhiTexture.Format = ... # 0x16
        BC7                      : QRhiTexture.Format = ... # 0x17
        ETC2_RGB8                : QRhiTexture.Format = ... # 0x18
        ETC2_RGB8A1              : QRhiTexture.Format = ... # 0x19
        ETC2_RGBA8               : QRhiTexture.Format = ... # 0x1a
        ASTC_4x4                 : QRhiTexture.Format = ... # 0x1b
        ASTC_5x4                 : QRhiTexture.Format = ... # 0x1c
        ASTC_5x5                 : QRhiTexture.Format = ... # 0x1d
        ASTC_6x5                 : QRhiTexture.Format = ... # 0x1e
        ASTC_6x6                 : QRhiTexture.Format = ... # 0x1f
        ASTC_8x5                 : QRhiTexture.Format = ... # 0x20
        ASTC_8x6                 : QRhiTexture.Format = ... # 0x21
        ASTC_8x8                 : QRhiTexture.Format = ... # 0x22
        ASTC_10x5                : QRhiTexture.Format = ... # 0x23
        ASTC_10x6                : QRhiTexture.Format = ... # 0x24
        ASTC_10x8                : QRhiTexture.Format = ... # 0x25
        ASTC_10x10               : QRhiTexture.Format = ... # 0x26
        ASTC_12x10               : QRhiTexture.Format = ... # 0x27
        ASTC_12x12               : QRhiTexture.Format = ... # 0x28
...
class QRhiTextureRenderTarget(PySide6.QtGui.QRhiRenderTarget):
    ...
    class Flag(enum.Flag):
        ...
        PreserveColorContents    : QRhiTextureRenderTarget.Flag = ... # 0x1
        PreserveDepthStencilContents: QRhiTextureRenderTarget.Flag = ... # 0x2
    ...
    def newCompatibleRenderPassDescriptor(self) -> PySide6.QtGui.QRhiRenderPassDescriptor: ...
    def resourceType(self) -> PySide6.QtGui.QRhiResource.Type: ...
    def setDescription(self, desc: Union[PySide6.QtGui.QRhiTextureRenderTargetDescription, PySide6.QtGui.QRhiColorAttachment]) -> None: ...
...
class QRhiTextureRenderTargetDescription(Shiboken.Object):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, QRhiTextureRenderTargetDescription: Union[PySide6.QtGui.QRhiTextureRenderTargetDescription, PySide6.QtGui.QRhiColorAttachment]) -> None: ...
    @overload
    def __init__(self, colorAttachment: Union[PySide6.QtGui.QRhiColorAttachment, PySide6.QtGui.QRhiRenderBuffer, PySide6.QtGui.QRhiTexture]) -> None: ...
    @overload
    def __init__(self, colorAttachment: Union[PySide6.QtGui.QRhiColorAttachment, PySide6.QtGui.QRhiRenderBuffer, PySide6.QtGui.QRhiTexture], depthStencilBuffer: PySide6.QtGui.QRhiRenderBuffer) -> None: ...
    @overload
    def __init__(self, colorAttachment: Union[PySide6.QtGui.QRhiColorAttachment, PySide6.QtGui.QRhiRenderBuffer, PySide6.QtGui.QRhiTexture], depthTexture: PySide6.QtGui.QRhiTexture) -> None: ...
    ...
    def setColorAttachments(self, bcolor_attachments: Sequence[PySide6.QtGui.QRhiColorAttachment]) -> None: ...
...
class QRhiTextureSubresourceUploadDescription(Shiboken.Object):
    ...
    @overload
    def __init__(self, data: Union[PySide6.QtCore.QByteArray, bytes, bytearray, memoryview]) -> None: ...
    @overload
...
class QRhiTextureUploadDescription(Shiboken.Object):
    ...
    def setEntries(self, entries: Sequence[PySide6.QtGui.QRhiTextureUploadEntry]) -> None: ...
...
class QRhiVertexInputAttribute(Shiboken.Object):
    ...
    class Format(enum.Enum):
        ...
        Float4                   : QRhiVertexInputAttribute.Format = ... # 0x0
        Float3                   : QRhiVertexInputAttribute.Format = ... # 0x1
        Float2                   : QRhiVertexInputAttribute.Format = ... # 0x2
        Float                    : QRhiVertexInputAttribute.Format = ... # 0x3
        UNormByte4               : QRhiVertexInputAttribute.Format = ... # 0x4
        UNormByte2               : QRhiVertexInputAttribute.Format = ... # 0x5
        UNormByte                : QRhiVertexInputAttribute.Format = ... # 0x6
        UInt4                    : QRhiVertexInputAttribute.Format = ... # 0x7
        UInt3                    : QRhiVertexInputAttribute.Format = ... # 0x8
        UInt2                    : QRhiVertexInputAttribute.Format = ... # 0x9
        UInt                     : QRhiVertexInputAttribute.Format = ... # 0xa
        SInt4                    : QRhiVertexInputAttribute.Format = ... # 0xb
        SInt3                    : QRhiVertexInputAttribute.Format = ... # 0xc
        SInt2                    : QRhiVertexInputAttribute.Format = ... # 0xd
        SInt                     : QRhiVertexInputAttribute.Format = ... # 0xe
        Half4                    : QRhiVertexInputAttribute.Format = ... # 0xf
        Half3                    : QRhiVertexInputAttribute.Format = ... # 0x10
        Half2                    : QRhiVertexInputAttribute.Format = ... # 0x11
        Half                     : QRhiVertexInputAttribute.Format = ... # 0x12
...
class QRhiVertexInputBinding(Shiboken.Object):
    ...
    class Classification(enum.Enum):
        ...
        PerVertex                : QRhiVertexInputBinding.Classification = ... # 0x0
        PerInstance              : QRhiVertexInputBinding.Classification = ... # 0x1


    @overload
    def __init__(self) -> None: ...
    @overload
    def __init__(self, QRhiVertexInputBinding: Union[PySide6.QtGui.QRhiVertexInputBinding, int]) -> None: ...
    @overload
...
class QRhiVertexInputLayout(Shiboken.Object):
    ...
    def setAttributes(self, attributes: Sequence[PySide6.QtGui.QRhiVertexInputAttribute]) -> None: ...
    def setBindings(self, bindings: Sequence[PySide6.QtGui.QRhiVertexInputBinding]) -> None: ...
...
class QShader(Shiboken.Object):
    ...
    class SerializedFormatVersion(enum.Enum):
        ...
        Latest                   : QShader.SerializedFormatVersion = ... # 0x0
        Qt_6_5                   : QShader.SerializedFormatVersion = ... # 0x1
        Qt_6_4                   : QShader.SerializedFormatVersion = ... # 0x2

    class Source(enum.Enum):

        SpirvShader              : QShader.Source = ... # 0x0
        GlslShader               : QShader.Source = ... # 0x1
        HlslShader               : QShader.Source = ... # 0x2
        DxbcShader               : QShader.Source = ... # 0x3
        MslShader                : QShader.Source = ... # 0x4
        DxilShader               : QShader.Source = ... # 0x5
        MetalLibShader           : QShader.Source = ... # 0x6
        WgslShader               : QShader.Source = ... # 0x7

    class Stage(enum.Enum):

        VertexStage              : QShader.Stage = ... # 0x0
        TessellationControlStage : QShader.Stage = ... # 0x1
        TessellationEvaluationStage: QShader.Stage = ... # 0x2
        GeometryStage            : QShader.Stage = ... # 0x3
        FragmentStage            : QShader.Stage = ... # 0x4
        ComputeStage             : QShader.Stage = ... # 0x5

    class Variant(enum.Enum):

        StandardShader           : QShader.Variant = ... # 0x0
        BatchableVertexShader    : QShader.Variant = ... # 0x1
        UInt16IndexedVertexAsComputeShader: QShader.Variant = ... # 0x2
        UInt32IndexedVertexAsComputeShader: QShader.Variant = ... # 0x3
        NonIndexedVertexAsComputeShader: QShader.Variant = ... # 0x4
    ...
    @staticmethod
    def __copy__() -> None: ...
    def availableShaders(self) -> List[PySide6.QtGui.QShaderKey]: ...
    @staticmethod
    def fromSerialized(data: Union[PySide6.QtCore.QByteArray, bytes, bytearray, memoryview]) -> PySide6.QtGui.QShader: ...
    def isValid(self) -> bool: ...
    def nativeResourceBindingMap(self, key: PySide6.QtGui.QShaderKey) -> Dict[int, Tuple[int, int]]: ...
    ...
    def setResourceBindingMap(self, key: PySide6.QtGui.QShaderKey, map: Dict[int, Tuple[int, int]]) -> None: ...
    def setShader(self, key: PySide6.QtGui.QShaderKey, shader: Union[PySide6.QtGui.QShaderCode, PySide6.QtCore.QByteArray]) -> None: ...
...
class QShaderCode(Shiboken.Object):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, QShaderCode: Union[PySide6.QtGui.QShaderCode, PySide6.QtCore.QByteArray]) -> None: ...
    @overload
    def __init__(self, code: Union[PySide6.QtCore.QByteArray, bytes, bytearray, memoryview], entry: Union[PySide6.QtCore.QByteArray, bytes, bytearray, memoryview] = ...) -> None: ...

    @staticmethod
    def __copy__() -> None: ...
    def entryPoint(self) -> PySide6.QtCore.QByteArray: ...
    def setEntryPoint(self, entry: Union[PySide6.QtCore.QByteArray, bytes, bytearray, memoryview]) -> None: ...
    def setShader(self, code: Union[PySide6.QtCore.QByteArray, bytes, bytearray, memoryview]) -> None: ...
...
class QShaderKey(Shiboken.Object):
    ...
    @overload
    def __init__(self, s: PySide6.QtGui.QShader.Source, sver: Union[PySide6.QtGui.QShaderVersion, int], svar: PySide6.QtGui.QShader.Variant = ...) -> None: ...

    @staticmethod
    def __copy__() -> None: ...
    def setSource(self, s: PySide6.QtGui.QShader.Source) -> None: ...
    def setSourceVariant(self, svar: PySide6.QtGui.QShader.Variant) -> None: ...
    def setSourceVersion(self, sver: Union[PySide6.QtGui.QShaderVersion, int]) -> None: ...
...
class QShaderVersion(Shiboken.Object):
    ...
    class Flag(enum.Flag):
        ...
        GlslEs                   : QShaderVersion.Flag = ... # 0x1


    @overload
    def __init__(self) -> None: ...
    @overload
    def __init__(self, QShaderVersion: Union[PySide6.QtGui.QShaderVersion, int]) -> None: ...
    @overload
...
class QShortcut(PySide6.QtCore.QObject):
    ...
    @overload
    def __init__(self, key: PySide6.QtGui.QKeySequence.StandardKey, parent: PySide6.QtCore.QObject, member: Union[bytes, bytearray, memoryview, NoneType] = ..., ambiguousMember: Union[bytes, bytearray, memoryview, NoneType] = ..., context: PySide6.QtCore.Qt.ShortcutContext = ...) -> None: ...
    @overload
    def __init__(self, key: Union[PySide6.QtGui.QKeySequence, PySide6.QtCore.QKeyCombination, PySide6.QtGui.QKeySequence.StandardKey, str, int], parent: PySide6.QtCore.QObject, member: Union[bytes, bytearray, memoryview, NoneType] = ..., ambiguousMember: Union[bytes, bytearray, memoryview, NoneType] = ..., context: PySide6.QtCore.Qt.ShortcutContext = ...) -> None: ...
    @overload
    def __init__(self, parent: PySide6.QtCore.QObject) -> None: ...
...
class QSyntaxHighlighter(PySide6.QtCore.QObject):
    ...
    @overload
    def setFormat(self, start: int, count: int, color: Union[PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, Any, PySide6.QtCore.Qt.GlobalColor, int]) -> None: ...
    @overload
...
class QTextCharFormat(PySide6.QtGui.QTextFormat):
    ...
    def setToolTip(self, tip: str) -> None: ...
    def setUnderlineColor(self, color: Union[PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, Any, PySide6.QtCore.Qt.GlobalColor, int]) -> None: ...
